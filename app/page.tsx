...
export default function Home() {
  ...
  const addItem = async (values: ItemFormValues) => {
    ...
    try {
      ...
      await removeUploadedStoragePaths(client, uploadedPaths);
      throw uploadError;
    }
    await reload();
    closeOverlay();
